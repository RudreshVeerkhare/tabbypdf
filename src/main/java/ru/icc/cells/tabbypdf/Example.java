...
// try {
// List<Page> pages = new
// PdfDataExtractor.Factory().getPdfBoxTextExtractor(file).getPageContent();
...
// private static void writeTableTextBlocks(List<TableBox> tableBoxes, String
// fileName) {
// TableTextBlockToXmlWriter writer = new TableTextBlockToXmlWriter(fileName);
// try {
// FileWriter fileWriter = new FileWriter(
// SAVE_PDF_DIR + "xml/" + fileName.substring(0, fileName.lastIndexOf('.')) +
// "-blk-output.xml");
...
// private static void writeTableBoxes(List<TableBox> tableBoxes, String
// fileName) {
...
// try {
// FileWriter fileWriter = new FileWriter(SAVE_PDF_DIR + "html/" + fileName +
// "." + i + ".html");
